...
namespace Puppet
{
    ...
    [CustomEditor(typeof(RootMotion.Dynamics.PuppetMaster))]
    public class PuppetMasterInspector : Editor
    {

        private RootMotion.Dynamics.PuppetMaster script { get { return target as RootMotion.Dynamics.PuppetMaster; } }
        ...
        public static bool AddPropMuscle(RootMotion.Dynamics.PuppetMaster script, ConfigurableJoint addPropMuscleTo, Vector3 position, Quaternion rotation, Vector3 additionalPinOffset, Transform targetParent = null)
        {
